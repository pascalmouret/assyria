...
/* Command for C compiler:
   ./cross/bin/i586-elf-gcc -c -w -w -nostdlib -ffreestanding -O2 -Wall -Wextra -O3 -fno-strict-aliasing  -I/usr/local/Cellar/nim/0.18.0/nim/lib -o /Users/pascalmouret/workspace/nimOS/src/kernel/nim/nimcache/stdlib_system.o /Users/pascalmouret/workspace/nimOS/src/kernel/nim/nimcache/stdlib_system.c */
